...
lm1 <-
  seg_scores %>%
  filter(res_stdid == 1, grade == 2) %>% 
  lm(seg_score ~ diversity + majtype, data = .)

lm2 <-
  seg_scores %>%
  filter(res_stdid == 0, grade == 2) %>% 
  lm(seg_score ~ diversity + majtype, data = .)

lm3 <-
  seg_scores %>%
  filter(res_stdid == 1, grade == 2) %>% 
  lm(seg_score ~ fac_res_prop + majtype, data = .)
...
lm1 <-
  seg_scores %>%
  filter(res_stdid == 1, grade == 2, elite == 1) %>% 
  lm(seg_score ~ diversity + majtype, data = .)

lm2 <-
  seg_scores %>%
  filter(res_stdid == 0, grade == 2, elite == 1) %>% 
  lm(seg_score ~ diversity + majtype, data = .)
...
lm1 <-
  seg_scores %>%
  filter(res_stdid == 1, grade == 2, elite == 0) %>% 
  lm(seg_score ~ diversity + majtype, data = .)

lm2 <-
  seg_scores %>%
  filter(res_stdid == 0, grade == 2, elite == 0) %>% 
  lm(seg_score ~ diversity + majtype, data = .)
