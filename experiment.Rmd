...
```{r, eval = F}
seg_scores %>% 
  lm(diversity ~ female + age + score + father_ed_ind + mother_ed_ind + school_years_english + classid, data = .) %>% 
  summary()

seg_scores %>% 
  lm(fac_res_prop ~ female + age + score + father_ed_ind + mother_ed_ind + school_years_english + classid, data = .) %>% 
  summary()
```
...
lm1 <-
  seg_scores %>%
  filter(res_stdid == 1) %>% 
  lm(seg_score ~ diversity + classid + female + age + score + father_ed_ind + mother_ed_ind + school_years_english, data = .)
...
lm3 <-
  seg_scores %>%
  filter(res_stdid == 1) %>% 
  lm(seg_score ~ fac_res_prop + classid + female + age + score + father_ed_ind + mother_ed_ind + school_years_english, data = .)
