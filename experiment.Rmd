...
lm1 <-
  ...
  lm_robust(e_seg_new ~ stu_diversity + female + age + score + b_seg_new + ses + hs_private + father_college, data = ., fixed_effects = ~ classid, clusters = classid, se_type = "stata")
...
lm3 <-
  seg_scores %>%
  filter(reservation == 1) %>% 
  lm_robust(e_seg_new ~ fac_diversity + female + age + score + b_seg_new + ses + hs_private + father_college, data = ., fixed_effects = ~ classid, clusters = classid, se_type = "stata")
